 ...
 * Description: This plugin creates a widget that can be used to display a music player which includes artist's name,
 * song and a cover image. Version: 1.6 Author: Dolatabadi Text Domain: simple-music-widget Domain Path: /languages
 * Author URI: https://github.com/dolatabadi License: GNU General Public License v2.
 */
 ...
 * Set constants
 */
define( 'SIMPLE_MUSIC_WIDGET_VERSION', '1.5' );
